...
# -*- encoding: utf-8 -*-
#
# Compile Algol-GDR source into object file.
# Invoke dispak simulator to run Algol compiler.
# Produce an output image in binary format:
#   filename.obj
#
# Leave twree imtermediate files:
#   filename.b6     -- task file for dispak simulator
#   filename.lst    -- listing generated by Algol
...
#
if len(sys.argv) < 2:
    print("Usage: algol-to-obj.py filename.alg")
    sys.exit(1)
...
if retval == 127:
    ...
    sys.exit(1)
if retval != 0:
    print("dispak: Failed to invoke Algol compiler")
    sys.exit(1)
if nerrors != 0:
    print("dispak: Algol errors detected: see %s.lst for details" % basename)
    sys.exit(1)
