...
# -*- encoding: utf-8 -*-
#
# Compile Fortran-Dubna source into object file.
# Invoke dispak simulator to run Fortran compiler.
# Produce an output image in binary format:
#   filename.obj
#
# Leave twree imtermediate files:
#   filename.b6     -- task file for dispak simulator
#   filename.lst    -- listing generated by Fortran
...
for line in dispak.stdout.readlines():
    ...
    if len(line) == 69 and line[38:68] == u"ТАБЛИЦА  ОТНОСИТЕЛЬНЫХ АДРЕСОВ":
        nerrors = 0
