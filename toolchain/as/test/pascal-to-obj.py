...
# -*- encoding: utf-8 -*-
#
# Compile Pascal source into object file.
# Invoke dispak simulator to run Pascal compiler.
...
#
import sys, os, string, subprocess, struct, re

#
# Parse command line.
#
if len(sys.argv) < 2:
    print "Usage: pascal-to-obj.py filename.pas"
    sys.exit(1)
...
nerrors = 0
pattern = re.compile(u" IN .* LINЕS .* ЕRRОRS")
...
if retval == 127:
    ...
    sys.exit(1)
if retval != 0:
    print "dispak: Failed to invoke Pascal compiler"
    sys.exit(1)
if nerrors != 0:
